...
<script type="text/javascript" src="/main/js/boardfree.js"></script> 	
</head>
<body>
<jsp:include page="Header.jsp"></jsp:include>
	...
	<div class="container-fluid">
        ...
        <div class="col-6 no-padding">
            <img src="/main/img/001.png" class="rounded" alt="..." width="100%" onclick="location.href='/yomuka/board/notice'">
        </div>
        <div class="col-6 no-padding">
